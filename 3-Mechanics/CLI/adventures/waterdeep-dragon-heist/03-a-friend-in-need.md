...
A hostile [gazer](/3-Mechanics/CLI/bestiary/aberration/gazer-vgm.md) (see appendix B) that is in league with [Grum'shar](/3-Mechanics/CLI/bestiary/npc/grumshar-wdh.md), the local Xanathar Guild boss, guards this intersection. Once the characters defeat it, they can press on, following the corridor where the chalk symbol is located; they reach the hideout after following the correct tunnel for 5 minutes.
