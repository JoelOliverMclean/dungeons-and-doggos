...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/MPMM/Hobgoblin%20Devastator.webp#right)  
...
**2/day each**: [fireball](/3-Mechanics/CLI/spells/fireball.md), [fly](/3-Mechanics/CLI/spells/fly.md), [fog cloud](/3-Mechanics/CLI/spells/fog-cloud.md), [gust of wind](/3-Mechanics/CLI/spells/gust-of-wind.md), [lightning bolt](/3-Mechanics/CLI/spells/lightning-bolt.md)
...
***Devastating Bolt.*** *Ranged Spell Attack:* +5 to hit, range 60 ft., one target. *Hit:* 21 (`4d8 + 3`) force damage, and the target is knocked [prone](/3-Mechanics/CLI/rules/conditions.md#prone).
```
^statblock
