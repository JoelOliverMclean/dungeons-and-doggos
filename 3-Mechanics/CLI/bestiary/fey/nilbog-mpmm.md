...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/MPMM/Nilbog.webp#right)  
...
**At will**: [mage hand](/3-Mechanics/CLI/spells/mage-hand.md), [Tasha's hideous laughter](/3-Mechanics/CLI/spells/tashas-hideous-laughter.md)
...
***Nimble Escape.*** The nilbog takes the [Disengage](/3-Mechanics/CLI/rules/actions.md#Disengage) or [Hide](/3-Mechanics/CLI/rules/actions.md#Hide) action.
