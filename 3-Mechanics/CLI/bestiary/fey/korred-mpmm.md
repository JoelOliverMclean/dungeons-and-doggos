...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/MPMM/Korred.webp#right)  
...
***Stone Camouflage.*** The korred has advantage on Dexterity ([Stealth](/3-Mechanics/CLI/rules/skills.md#Stealth)) checks made to hide in rocky terrain.
...
**At will**: [commune with nature](/3-Mechanics/CLI/spells/commune-with-nature.md) (as an action), [meld into stone](/3-Mechanics/CLI/spells/meld-into-stone.md), [stone shape](/3-Mechanics/CLI/spells/stone-shape.md)

**1/day**: [Otto's irresistible dance](/3-Mechanics/CLI/spells/ottos-irresistible-dance.md)
