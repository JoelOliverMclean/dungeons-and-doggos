...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/MPMM/Yuan-ti%20Mind%20Whisperer.webp#right)  
...
**At will**: [animal friendship](/3-Mechanics/CLI/spells/animal-friendship.md) (snakes only), [message](/3-Mechanics/CLI/spells/message.md), [minor illusion](/3-Mechanics/CLI/spells/minor-illusion.md), [prestidigitation](/3-Mechanics/CLI/spells/prestidigitation.md)

**2/day each**: [detect thoughts](/3-Mechanics/CLI/spells/detect-thoughts.md), [hypnotic pattern](/3-Mechanics/CLI/spells/hypnotic-pattern.md)
