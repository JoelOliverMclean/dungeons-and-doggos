...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/MPMM/Female%20Steeder.webp#right)  
## Steeders
...
***Sticky Leg.*** *Melee Weapon Attack:* +5 to hit, reach 5 ft., one Medium or smaller creature. *Hit:* The target is stuck to the steeder's leg and [grappled](/3-Mechanics/CLI/rules/conditions.md#grappled) (escape DC 12). The steeder can have only one creature [grappled](/3-Mechanics/CLI/rules/conditions.md#grappled) at a time.
```
^statblock
