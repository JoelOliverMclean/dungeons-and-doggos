...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/MPMM/Yagnoloth.webp#right)  
...
***Massive Arm.*** *Melee Weapon Attack:* +8 to hit, reach 15 ft., one target. *Hit:* 23 (`3d12 + 4`) force damage. If the target is a creature, it must succeed on a DC 16 Constitution saving throw or become [stunned](/3-Mechanics/CLI/rules/conditions.md#stunned) until the end of the yagnoloth's next turn.
