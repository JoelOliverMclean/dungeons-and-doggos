...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/MPMM/Star%20Spawn%20Mangler.webp#right)  
...
***Shadow Stealth.*** While in dim light or darkness, the mangler takes the [Hide](/3-Mechanics/CLI/rules/actions.md#Hide) action.
```
^statblock