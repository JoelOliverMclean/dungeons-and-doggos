...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/MM/Death%20Knight.webp#right)  
...
***Marshal Undead.*** Unless the death knight is [incapacitated](/3-Mechanics/CLI/rules/conditions.md#incapacitated), it and undead creatures of its choice within 60 feet of it have advantage on saving throws against features that turn undead.
...
**4th level (3 slots)**: [banishment](/3-Mechanics/CLI/spells/banishment.md), [staggering smite](/3-Mechanics/CLI/spells/staggering-smite.md)
