...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/MPMM/Deathlock%20Mastermind.webp#right)  
...
***Devil's Sight.*** Magical darkness doesn't impede the deathlock's [darkvision](/3-Mechanics/CLI/rules/senses.md#darkvision).
...
**At will**: [detect magic](/3-Mechanics/CLI/spells/detect-magic.md), [disguise self](/3-Mechanics/CLI/spells/disguise-self.md), [mage armor](/3-Mechanics/CLI/spells/mage-armor.md), [minor illusion](/3-Mechanics/CLI/spells/minor-illusion.md)

**1/day each**: [darkness](/3-Mechanics/CLI/spells/darkness.md), [dimension door](/3-Mechanics/CLI/spells/dimension-door.md), [dispel magic](/3-Mechanics/CLI/spells/dispel-magic.md), [fly](/3-Mechanics/CLI/spells/fly.md), [invisibility](/3-Mechanics/CLI/spells/invisibility.md)
