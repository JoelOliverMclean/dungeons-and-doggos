...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/MPMM/Boneclaw.webp#right)  
...
***Piercing Claw.*** *Melee Weapon Attack:* +8 to hit, reach 15 ft., one target. *Hit:* 20 (`3d10 + 4`) piercing damage plus 11 (`2d10`) necrotic damage. If the target is a creature, the boneclaw can pull the target up to 10 feet toward itself, and the target is [grappled](/3-Mechanics/CLI/rules/conditions.md#grappled) (escape DC 14). The boneclaw has two claws. While a claw grapples a target, the claw can attack only that target.
...
***Shadow Stealth.*** While in dim light or darkness, the boneclaw takes the [Hide](/3-Mechanics/CLI/rules/actions.md#Hide) action.
