...
***Sneak Attack (1/Turn).*** Torbit deals an extra 14 (`4d6`) damage when it hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 feet of an ally of Torbit that isn't [incapacitated](/3-Mechanics/CLI/rules/conditions.md#incapacitated) and Torbit doesn't have disadvantage on the attack roll.
