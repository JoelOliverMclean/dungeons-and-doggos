...
```ad-statblock
title: Mobar
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/WDMM/Mobar.webp#token)
...
***Echolocation (Bat or Hybrid Form Only).*** Mobar has blindsight out to a range of 60 feet as long as it's not [deafened](/3-Mechanics/CLI/rules/conditions.md#deafened).
