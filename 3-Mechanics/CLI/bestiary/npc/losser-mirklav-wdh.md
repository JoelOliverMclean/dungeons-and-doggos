...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/WDH/Losser%20Mirklav.webp#token)
...
***Brave.*** Losser has advantage on saving throws against being [frightened](/3-Mechanics/CLI/rules/conditions.md#frightened).
...
**3rd level (3 slots)**: [animate dead](/3-Mechanics/CLI/spells/animate-dead.md), [fireball](/3-Mechanics/CLI/spells/fireball.md), [fly](/3-Mechanics/CLI/spells/fly.md)

**4th level (3 slots)**: [blight](/3-Mechanics/CLI/spells/blight.md), [ice storm](/3-Mechanics/CLI/spells/ice-storm.md)
