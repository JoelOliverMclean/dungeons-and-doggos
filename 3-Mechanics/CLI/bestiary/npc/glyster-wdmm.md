...
```ad-statblock
title: Glyster
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/WDMM/Glyster.webp#token)
...
***Detect.*** Glyster makes a Wisdom ([Perception](/3-Mechanics/CLI/rules/skills.md#Perception)) check.

***Tail Attack.*** Glyster makes a tail attack.

***Wing Attack (Costs 2 Actions).*** Glyster beats its wings. Each creature within 10 feet of Glyster must succeed on a DC 20 Dexterity saving throw or take 14 (`2d6 + 7`) bludgeoning damage and be knocked [prone](/3-Mechanics/CLI/rules/conditions.md#prone). Glyster can then fly up to half its flying speed.
```
^statblock