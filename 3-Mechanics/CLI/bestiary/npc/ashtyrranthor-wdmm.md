...
```ad-statblock
title: Ashtyrranthor
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/WDMM/Ashtyrranthor.webp#token)
...
***Detect.*** Ashtyrranthor makes a Wisdom ([Perception](/3-Mechanics/CLI/rules/skills.md#Perception)) check.
