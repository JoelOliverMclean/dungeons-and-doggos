...
- "desc": "Trobriand is an 18th-level spellcaster. His spellcasting ability is Intelligence\
    ...
    \n2nd level (3 slots): [blur](/3-Mechanics/CLI/spells/blur.md), [detect thoughts](/3-Mechanics/CLI/spells/detect-thoughts.md),\
    ...
    \ [incendiary cloud](/3-Mechanics/CLI/spells/incendiary-cloud.md), [power word\
