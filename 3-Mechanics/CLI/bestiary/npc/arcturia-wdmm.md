...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/WDMM/Arcturia.webp#right)  
...
```ad-statblock
title: Arcturia
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/WDMM/Arcturia.webp#token)
...
***Spellcasting.*** Arcturia is an 18th-level spellcaster. Her spellcasting ability is Intelligence (spell save DC 20, +12 to hit with spell attacks). Arcturia can cast [alter self](/3-Mechanics/CLI/spells/alter-self.md) at will and has the following wizard spells prepared:
...
**6th level (1 slots)**: [disintegrate](/3-Mechanics/CLI/spells/disintegrate.md), [flesh to stone](/3-Mechanics/CLI/spells/flesh-to-stone.md)

**7th level (1 slots)**: [reverse gravity](/3-Mechanics/CLI/spells/reverse-gravity.md), [teleport](/3-Mechanics/CLI/spells/teleport.md)

**8th level (1 slots)**: [feeblemind](/3-Mechanics/CLI/spells/feeblemind.md), [maze](/3-Mechanics/CLI/spells/maze.md)
