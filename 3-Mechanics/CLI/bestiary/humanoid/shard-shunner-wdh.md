...
```ad-statblock
title: Shard Shunner
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/WDH/Shard%20Shunner.webp#token)
...
***Brave.*** The Shard Shunner has advantage on saving throws against being [frightened](/3-Mechanics/CLI/rules/conditions.md#frightened).
