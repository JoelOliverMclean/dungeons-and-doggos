...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/MPMM/Drow%20House%20Captain.webp#right)  
...
***Battle Command.*** Choose one creature within 30 feet of the drow that the drow can see. If the chosen creature can see or hear the drow, that creature can use its reaction to make one melee attack or to take the [Dodge](/3-Mechanics/CLI/rules/actions.md#Dodge) or [Hide](/3-Mechanics/CLI/rules/actions.md#Hide) action.
