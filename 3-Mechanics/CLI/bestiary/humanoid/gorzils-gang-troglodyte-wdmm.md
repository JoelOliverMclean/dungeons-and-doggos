...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/WDMM/Gorzil's%20Gang%20Troglodyte.webp#token)
*Medium humanoid (troglodyte), Chaotic Evil*

- **Armor Class** 14 ([breastplate](/3-Mechanics/CLI/items/breastplate.md))
- **Hit Points** 13 (`2d8 + 4`) 
- **Speed** 30 ft.
