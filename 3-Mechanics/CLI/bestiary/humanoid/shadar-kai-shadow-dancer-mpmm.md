...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/MPMM/Shadar-kai%20Shadow%20Dancer.webp#right)  
...
- **3–4 Grapple.** The target is [grappled](/3-Mechanics/CLI/rules/conditions.md#grappled) (escape DC 14) if it is a Medium or smaller creature. Until the grapple ends, the target is [restrained](/3-Mechanics/CLI/rules/conditions.md#restrained), and the shadar-kai can't grapple another target.  
