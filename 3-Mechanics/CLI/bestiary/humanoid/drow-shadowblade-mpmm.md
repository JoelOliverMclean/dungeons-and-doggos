...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/MPMM/Drow%20Shadowblade.webp#right)  
...
***Devil's Sight.*** Magical darkness doesn't impede the drow's [darkvision](/3-Mechanics/CLI/rules/senses.md#darkvision).
...
**1/day each**: [faerie fire](/3-Mechanics/CLI/spells/faerie-fire.md), [levitate](/3-Mechanics/CLI/spells/levitate.md) (self only)
