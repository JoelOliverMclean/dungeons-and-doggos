...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/MM/Solar.webp#right)  
...
**3/day each**: [blade barrier](/3-Mechanics/CLI/spells/blade-barrier.md), [dispel evil and good](/3-Mechanics/CLI/spells/dispel-evil-and-good.md), [resurrection](/3-Mechanics/CLI/spells/resurrection.md)
...
***Blinding Gaze (Costs 3 Actions).*** The solar targets one creature it can see within 30 feet of it. If the target can see it, the target must succeed on a DC 15 Constitution saving throw or be [blinded](/3-Mechanics/CLI/rules/conditions.md#blinded) until magic such as the [lesser restoration](/3-Mechanics/CLI/spells/lesser-restoration.md) spell removes the blindness.
```
^statblock