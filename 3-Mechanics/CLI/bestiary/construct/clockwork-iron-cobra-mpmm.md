...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/MPMM/Clockwork%20Iron%20Cobra.webp#right)  
...
- **1–2 Confusion.** On its next turn, the target must use its action to make one weapon attack against a random creature it can see within 30 feet of it, using whatever weapon it has in hand and moving beforehand if necessary to get in range. If it's holding no weapon, it makes an unarmed strike. If no creature is visible within 30 feet, it takes the [Dash](/3-Mechanics/CLI/rules/actions.md#Dash) action, moving toward the nearest creature.  
- **3–4 Paralysis.** The target is [paralyzed](/3-Mechanics/CLI/rules/conditions.md#paralyzed) until the end of its next turn.  
