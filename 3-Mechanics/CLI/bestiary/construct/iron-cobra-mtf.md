...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/MTF/Iron%20Cobra.webp#right)  
...
```ad-statblock
title: Iron Cobra
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/MTF/Iron%20Cobra.webp#token)
...
3. Paralysis: The target is [paralyzed](/3-Mechanics/CLI/rules/conditions.md#paralyzed) until the end of its next turn.
```
^statblock
