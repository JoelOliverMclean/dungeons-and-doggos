...
- "desc": "A creature can grab the staff out of the air with a successful grapple\
    ...
    \ 12 Charisma saving throw or be [charmed](/3-Mechanics/CLI/rules/conditions.md#charmed)\
    \ by the staff until the staff is no longer in its grasp. While the creature is\
    \ [charmed](/3-Mechanics/CLI/rules/conditions.md#charmed), the staff can issue\
    ...
    \ success. A creature that successfully resists the staff's control can't be [charmed](/3-Mechanics/CLI/rules/conditions.md#charmed)\
...
- "desc": "The staff has 10 charges. It can expend 1 or more of its charges to cast\
    \ one of the following spells (save DC 12): [cone of cold](/3-Mechanics/CLI/spells/cone-of-cold.md)\
