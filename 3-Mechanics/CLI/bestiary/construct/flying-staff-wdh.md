...
***Antimagic Susceptibility.*** The staff is [incapacitated](/3-Mechanics/CLI/rules/conditions.md#incapacitated) while in the area of an [antimagic field](/3-Mechanics/CLI/spells/antimagic-field.md). If targeted by [dispel magic](/3-Mechanics/CLI/spells/dispel-magic.md), the staff must succeed on a Constitution saving throw against the caster's spell save DC or fall [unconscious](/3-Mechanics/CLI/rules/conditions.md#unconscious) for 1 minute.
