...
```ad-statblock
title: Animated Wand
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/WDMM/Animated%20Wand.webp#token)
...
***Wand of Wonder.*** The animated wand can expend 1 of its charges and target a random creature with one of its [randomly determined effects](/3-Mechanics/CLI/items/wand-of-wonder.md). Any such effect that would target the wand's user targets the wand instead. If reduced to 0 hit points, the wand crumbles into dust and is destroyed.
