...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/MM/Swarm%20of%20Bats.webp#right)  
...
***Echolocation.*** The swarm can't use its blindsight while [deafened](/3-Mechanics/CLI/rules/conditions.md#deafened).

***Keen Hearing.*** The swarm has advantage on Wisdom ([Perception](/3-Mechanics/CLI/rules/skills.md#Perception)) checks that rely on hearing.
