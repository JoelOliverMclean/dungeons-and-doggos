...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/WDMM/Huge%20Gray%20Ooze.webp#token)
*Huge ooze, Unaligned*
...
***Invisibility (Recharges after a Short or Long Rest).*** The ooze magically turns [invisible](/3-Mechanics/CLI/rules/conditions.md#invisible) for up to 1 hour until it attacks, it uses its Enlarge, or its [concentration](/3-Mechanics/CLI/rules/conditions.md#concentration) is broken (as if concentrating on a spell).
```
^statblock