...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/MPMM/Slithering%20Tracker.webp#right)  
...
***Watery Stealth.*** If underwater, the slithering tracker takes the [Hide](/3-Mechanics/CLI/rules/actions.md#Hide) action, and it makes the Dexterity ([Stealth](/3-Mechanics/CLI/rules/skills.md#Stealth)) check with advantage.
```
^statblock
